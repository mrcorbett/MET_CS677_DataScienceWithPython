...
(function(){
    ...
    (function() {
    var p = "3954055", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3954055||'',
    GUID:window.ftGUID_3954055||'99999999999',
    confID:window.ftConfID_3954055||'0',
    ftReturn: window.ftReturn_3954055||'',
    keyword:window.ftKeyword_3954055||'',
    ftId:window.ftId_3954055||'',
    imp:window.ftImp3954055,
    ftImpId:window.ftImp3954055 && window.ftImp3954055.impID || '',
    campaignID:'111994',
    cID:'108834',
    pID:'3954055',
    creativeID:'2743679',
    exttrack:["https://ad.doubleclick.net/ddm/trackimpj/N488001.1917624AODDISPLAY.COM/B22482244.251374769;dc_trk_aid=448250405;dc_trk_cid=119375981;ord=[timestamp];dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=?","https://pixel.mtrcs.samba.tv/v2/vtr/spark/vision053019/visionworksft/impression?c=[%FT_RANDOM%]&sa_cr=2743679&sa_pl=3954055&sa_siteid=16067"],
    extscript:[""],
    clickTags: ["http://servedby.flashtalking.com/click/8/111994;3954055;2743679;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://ad.doubleclick.net/ddm/trackclk/N488001.1917624AODDISPLAY.COM/B22482244.251374769;dc_trk_aid=448250405;dc_trk_cid=119375981;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=?https://locations.visionworks.com","http://servedby.flashtalking.com/click/8/111994;3954055;2743679;212;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=http://www.visionworks.com"],
    placementDescription:'DTDTFMBANITPOEPTPKCHTGCQTBHVPDLocationDataCompetitorVisitorLast30DaysSZ728X90ASDCMFTADAS3PTRCKPBNinthDecimalVVVGMRC70IAS',
    width:728,
    height:90,
    ...
    divID:'ftdiv3954055',
    phID:'ftpos3954055',
    frameID:'ftframe3954055',
    expID:'ftexpframe3954055',
    altImgID:'ftalt3954055',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/8/111994;3954055;2743679;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://ad.doubleclick.net/ddm/trackclk/N488001.1917624AODDISPLAY.COM/B22482244.251374769;dc_trk_aid=448250405;dc_trk_cid=119375981;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=?https://locations.visionworks.com',
    altImg:'http://servedby.flashtalking.com/imp/8/111994;3954055;204;gif;Vivaki;DTDTFMBANITPOEPTPKCHTGCQTBHVPDLocationDataCompetitorVisitorLast30DaysSZ728X90ASDCMFTADAS3PTRCKPBNinthDecimalVVVGMRC70IAS/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/111994;3954055;271;pixel;Vivaki;DTDTFMBANITPOEPTPKCHTGCQTBHVPDLocationDataCompetitorVisitorLast30DaysSZ728X90ASDCMFTADAS3PTRCKPBNinthDecimalVVVGMRC70IAS/?',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/395/3954055/2743679/js/j-3954055-2743679.js',
    file:'http://cdn.flashtalking.com/108834/2743679/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat8.flashtalking.com/reportV3/ft.stat?146866034-3954055;2743679;',
    adVis:false ? 1 : 0,
    centreAd:true,
    mvt:true,
    segment:window.ftSegment_3954055||'',
    segmentList:window.ftSegmentList_3954055||[],
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp3954055 && window.ftImp3954055.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m3954055')&&/^https:/.test(document.getElementById('ftscript_m3954055').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3954055'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_3954055'],
        ['ftcfid', 'ftConfID_3954055'],
        ['fttime', 'ftTimestamp_3954055'],
        ['ftsection', 'ftSection_3954055'],
        ['ftcustom', 'ftCustom_3954055'],
        ['ft_id', 'ftId_3954055'],
        ['ftimpid','ftImp3954055', 'impID']
    ]
};
